...
def select_int(sql, *args):
	'''
	Execute select SQL and expected one int and oen int result.
...
def update(sql, *args):
	...
	>>> u1 = dict(id = 1000, name = 'Micheal', email = 'micheal@test.org', passwd = '123456', last_modified = time.time())
	>>> insert('user', **u1)
	1
	...
	>>> u2.passwd
	u'123456'
	>>> update('UPDATE user SET email = ?, passwd = ? WHERE id = ?', 'micheal@test.org', '654321', 1000)
	1
